...
class Atouts extends Model
{
    ...
    {
        return parent::reading(new Atouts());
    }
    public function insert(Atouts $atouts)
    {
        parent::managing($atouts,$_FILES['image']);
        return true;
    }
    public function update(Atouts $atouts)
    {
        parent::updating($atouts);
        return true;
    }
    public function delete(Atouts $atouts)
    {
        parent::deleting($atouts,"image");
        return true;
    }
}
?>
